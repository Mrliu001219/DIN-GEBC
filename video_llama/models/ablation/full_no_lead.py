...
@registry.register_model("full_no_lead")
class Full_No_Lead(Blip2Base):
    """
    ...
    def encode_video_rwkv(self, q_hidden_state,difference):
        with self.maybe_autocast():
            # add frame_pos embedding
            batch_size, time_length, _, _ = q_hidden_state.size()
    ...
    def forward(self, samples):
        ...
        #before_and_after
        video_embeds_b_and_a, atts_video_b_and_a= self.encode_video_rwkv(b_and_a_tokens,b_and_a_tokens_difference)
