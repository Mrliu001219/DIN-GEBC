...
@registry.register_model("single_branch_rwkv")
class Single_Branch_RWKV(Blip2Base):
    """
    ...
    def encode_video_rwkv(self, q_hidden_state):
        with self.maybe_autocast():
            ...
            video_tokens = self.opt_proj_RWKV(video_hidden)
    ...
    def forward(self, samples):
        ...
        video_embeds, atts_video = self.encode_video_rwkv(image_query_tokens)
