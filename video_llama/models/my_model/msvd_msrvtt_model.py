...
@registry.register_model("msvd_msrvtt_model")
class MSVD_MSRVTT_model(Blip2Base):
    """
    ...
    def encode_video_qformer(self, q_hidden_state):
    ...
    def encode_video_rwkv(self, q_hidden_state,subject,difference):
        with self.maybe_autocast():
            ...
            #frame_hidden_state = q_hidden_state  # [12,12,64,768]
            ...
            lead_subject_difference = torch.cat([repeated_subject,difference],dim=3)#(12,12,32,1536)
    ...
    def forward(self, samples):
        ...
        video_embeds_subject, atts_video_subject, subject_video_tokens = self.encode_video_qformer(image_query_tokens)
        ...
        video_embeds_b_and_a, atts_video_b_and_a= self.encode_video_rwkv(image_query_tokens,subject_video_tokens,b_and_a_tokens_difference)
        ...
        loss_before_and_after = self.get_loss_before_and_after(video_embeds_b_and_a, atts_video_b_and_a, caption)
        ############################################################################################
        return loss_before_and_after
    ...
    def from_config(cls, cfg):
        ...
        pre_train = cfg.get("pre_train", False)
        ...
        if pre_train:
            ...
            if ckpt_path:
                print("Load GEBC Checkpoint: {}".format(ckpt_path))
