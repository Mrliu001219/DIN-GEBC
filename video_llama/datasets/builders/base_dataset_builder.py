...
class BaseDatasetBuilder:
    ...
    def build_datasets(self):
        ...
        #创建数据集对象
        #  video_llama/datasets/builders/gebc_builder.py
    ...
    def _build_proc_from_cfg(cfg):
        return (
            #返回获取到的视频处理实例    video_processor.py     base_porcessor.py
            registry.get_processor_class(cfg.name).from_config(cfg)#获取视频变换形状类实例
            if cfg is not None
            else None
        )
